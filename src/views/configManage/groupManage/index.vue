...
<div class="tab-container">
  <div class="tools">
    <div class="paddingb textl paddingr">
      <el-input v-model="input.objName" placeholder="可根据小组名称 查询" style="width: 20%;"></el-input>

      <el-button style="margin-left:20px" @click="loadPageList" type="primary" icon="el-icon-search"></el-button>

      <el-button style="margin-left: 10px;" @click="handleCreate" type="primary" icon="el-icon-edit">添加小组</el-button>
    ...
    <el-form class="" label-width="20%" style="text-align:left">
      ...
      <el-row :gutter="24">
        ...
        <el-form-item label="小组名称">
          <el-input v-model="obj.productName" placeholder="请输入小组名称" style="width:80%"></el-input>
        </el-form-item>
