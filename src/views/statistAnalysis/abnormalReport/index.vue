...
<div class="tab-container">
  ...
  <el-table v-loading="loading" class="tableH" :data="list" border style="margin-top:20px;width:100%;font-size:12px;">
    ...
    <el-table-column align="center" label="异常说明">
      <template slot-scope="scope">
        <span>
          {{ scope.row.abnormalDes}}</span>
      </template>
    </el-table-column>

    <el-table-column align="center" label="确认人">
      <template slot-scope="scope">
        <span>
          {{ scope.row.confirm}}</span>
      </template>
    </el-table-column>
    ...
    <el-form class="" label-width="20%" style="text-align:left">
      ...
      <el-row :gutter="24">
        ...
        <el-form-item label="编号">
          <el-input v-model="obj.productionDes" placeholder="请输入编号" style="width:80%"></el-input>
        </el-form-item>

        <el-form-item label="执行小组名">
          <el-input v-model="obj.production" placeholder="请输入执行小组名" style="width:80%"></el-input>
        </el-form-item>
