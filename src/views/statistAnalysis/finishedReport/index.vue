      ...
      <el-row :gutter="24">
        ...
        <el-form-item label="类型">
          <el-select v-model="obj.productType" style="width:100px" placeholder="请选择">
            ...
            <el-option label="管桩生产工程" :key=2 :value=2>
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="工序号">
          <el-input v-model="obj.productionDes" placeholder="请输入工序号" style="width:80%"></el-input>
        </el-form-item>

        <el-form-item label="编号">
          <el-input v-model="obj.production" placeholder="请输入编号" style="width:80%"></el-input>
        </el-form-item>
  ...
  data() {
    return {
      ...
      list: [{
        ...
        "qualified": 1,
        "productType": 1,
        "productionDes": "执行小组名1",
        "time": "2018-10-21 12:10:11"
